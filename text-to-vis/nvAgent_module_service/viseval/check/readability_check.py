            ...
            HumanMessage(content=[
                {
                    ...
                    "text",
                    "text":
                    f"""Visualization Requirement: {query}\n\n{reviews}Visualization image:""",
                },
                {
                    "type": "image_url",
                    "image_url": {
                ...
                },
                {
                    ...
                    "text",
                    "text":
                    """Please assess the readability, taking into account factors such as layout, scale and ticks, title and labels, colors, and ease of extracting information. Do not consider the correctness of the data and order in the visualizations, as they have already been verified.""",
                },
            ]))
