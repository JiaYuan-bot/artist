...
def _get_prompt_template(template_name: str,
                         **kwargs: Any) -> HumanMessagePromptTemplate:
    """
    ...
    template_configs = {
        ...
        "column_filtering": {
            "input_variables": ["COLUMN_PROFILE", "QUESTION", "HINT"]
        },
        ...
        "table_selection": {
            "input_variables": ["HINT", "QUESTION"],
            "partial_variables": {
                "DATABASE_SCHEMA": kwargs.get("schema_string", "")
            }
        },
        "column_selection": {
            "input_variables": ["HINT", "QUESTION"],
        ...
        "revision": {
            "input_variables": [
                "SQL", "QUESTION", "MISSING_ENTITIES", "EVIDENCE",
                "QUERY_RESULT"
            ],
            "partial_variables": {
                "DATABASE_SCHEMA": kwargs.get("schema_string", "")
...
def get_prompt(template_name: str,
               schema_string: str = None) -> ChatPromptTemplate:
    """
    ...
    """
    human_message_prompt_template = _get_prompt_template(
        template_name=template_name, schema_string=schema_string)
