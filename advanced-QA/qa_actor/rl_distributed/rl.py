...
NODE_COSTS = {
    ...
    ### qa
    "question_to_query_small": 10.0,
    "question_to_query_large": 30.0,
    "retrieval1_3": 1.0,
    "context_question_to_query_small": 10,
    "context_question_to_query_large": 30.0,
    "retrieval2_3": 1.0,
    "rerank_small": 30.0,
    "rerank_large": 50.0,
    "context_question_to_answer_small_cot": 10.0,
    "context_question_to_answer_medium_cot": 20.0,
    "context_question_to_answer_large_cot": 30.0,
    "qa_evaluation": 1.0
}
