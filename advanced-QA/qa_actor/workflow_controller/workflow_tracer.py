...
class FunctionServiceClient:
    ...
    def __init__(self, host='localhost', port=50051):
        ...
        self.function_map = {
            ...
            ### qa ###
            'question_to_query': {
                'method': self.stub.question_to_query,
                'request_class': functions_pb2.QuestionToQueryReq,
                'reply_class': functions_pb2.QuestionToQueryReply
            },
            'retrieval1': {
                'method': self.stub.retrieval1,
                'request_class': functions_pb2.Retrieval1Req,
                'reply_class': functions_pb2.Retrieval2Reply
            },
            'context_question_to_query': {
                'method': self.stub.context_question_to_query,
                'request_class': functions_pb2.ContextQuestionToQueryReq,
                'reply_class': functions_pb2.ContextQuestionToQueryReply
            },
            'retrieval2': {
                'method': self.stub.retrieval2,
                'request_class': functions_pb2.Retrieval2Req,
                'reply_class': functions_pb2.Retrieval2Reply
            },
            'rerank': {
                'method': self.stub.rerank,
                'request_class': functions_pb2.RerankReq,
                'reply_class': functions_pb2.RerankReply
            },
            'context_question_to_answer': {
                'method': self.stub.context_question_to_answer,
                'request_class': functions_pb2.ContextQuestionToAnswerReq,
                'reply_class': functions_pb2.ContextQuestionToAnswerReply
            },
            'qa_evaluation': {
                'method': self.stub.qa_evaluation,
                'request_class': functions_pb2.QaEvaluationReq,
                'reply_class': functions_pb2.QaEvaluationReply
            },
        }
...
class WorkflowTracer:
    ...
    def qa_execution_score(self) -> float:
        """Calculate metrics for RL reward calculation"""
        if not self.current_state:
            return False

        qa_evaluation_result = self.current_state.accumulated_outputs.get(
            "qa_evaluation")['keys'].get("execution_history")[-1]
        return qa_evaluation_result.get("f1_score")
