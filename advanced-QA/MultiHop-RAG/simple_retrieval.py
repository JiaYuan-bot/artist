...
if __name__ == '__main__':
    ...
    if 'text' in model_name:
        ...
        embed_model = VoyageEmbedding(model_name='voyage-02',
    ...
    if rerank:
        rerank_postprocessors = FlagEmbeddingReranker(
            model="BAAI/bge-reranker-large", top_n=top_k)
